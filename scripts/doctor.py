...
def check_paths() -> list[CheckResult]:
    required_files = [
        ...
        ROOT / "scripts" / "normalize-defillama.py",
        ROOT / "scripts" / "normalize-github.py",
        ROOT / "scripts" / "normalize-rootdata.py",
        ROOT / "scripts" / "normalize-surf.py",
